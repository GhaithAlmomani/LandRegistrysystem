...
<style>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <p>Update Userame</p>
        <input type="text" name="name" placeholder="Userame" maxlength="50" class="box">
        <p>Update Email</p>
        <input type="email" name="email" placeholder="example@mail.com" maxlength="50" class="box">
        ...
        <a href="profile" class="inline-btn">Submit</a>
    </form>
